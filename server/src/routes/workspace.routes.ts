...
router
  .route('/')
  .post(isAuth, validate(CreateWorkspaceInput), workspaceControllers.createWorkspace)
...
router.post('/join', isAuth, validate(JoinWorkspaceInput), workspaceControllers.joinWorkspace);
router.post('/:id/invite', isAuth, validate(InviteUserInput), workspaceControllers.inviteUserToWorkspace);
router.post('/:id/leave', isAuth, workspaceControllers.leaveWorkspace);
router.get('/invite_id/:id', isAuth, workspaceControllers.getWorkspaceByInviteId);
